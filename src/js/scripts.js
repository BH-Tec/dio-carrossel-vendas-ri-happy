...
function renderProducts(products) {
    ...
    products.forEach(product => {
        ...
        <div class="product-card">
            <img class="imageProduct" src="${product.imageUrl}" alt="${product.productName}" />
            ...
            <p class="seller">${product.seller === 'RiHappy' ? `Vendido por <span class="sellerType">${product.seller}</span>` : `Oferta por <span class="sellerType">${product.seller}</span>`}</p>
        </div>
    `
